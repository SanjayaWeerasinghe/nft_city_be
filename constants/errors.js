...
const ErrorMessages = {
    COMMON_VALIDATION_ERROR: {
        ...
        ID_NOT_VALID_MONGO_KEY: (key) => `${key} not valid mongo key.`,
    ...
    AUTH: {
        ...
        UNVERIFIED_ACCOUNT: "Your account is not verified. Click the below verification link to verify your account.",
        ...
        INVALID_OTP: "The code you entered is incorrect. Please enter the correct OTP.",
        ...
        OLD_PASSWORD_MISMTACH:"The old password you entered does not match the previously stored password. Please verify the old password and try again.",
        SAME_PASSWORD_PREVIOUS:"Please avoid using the same password that was previously entered. Please choose a different password."
    },
    ...
    GENERIC_ERROR: {
        ...
        RECORD_NOT_FOUND: (record) => `There is no record found against this ${record}.`,
        INTERNEL_SERVER_ERROR: 'There is some internal server error.Please try again letter',
        INVALID_HASH: (address) => `This hash you provide not contain any transaction on our deposit address: ${address}.`,
        INVALID_EXPIRATION_DATE:`Please select a time greater than the current time.`,
        ITEM_ALREADY_EXIST: (item) =>`${item} already exist.`,
        COUPAN_EXPIRED: "coupon code has been expired",
    },
}
